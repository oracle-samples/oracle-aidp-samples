...
(function (ArtifactList) {
    function getJsonObj(obj) {
        ...
        delete jsonObj.rootUri;
        delete jsonObj.nextPageToken;
        return jsonObj;
    }
    ArtifactList.getJsonObj = getJsonObj;
    ;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            'rootUri': obj["root_uri"],
            'files': obj.files ?
                obj.files.map((item) => { return model.ArtifactFileInfo.getDeserializedJsonObj(item); })
                : undefined,
            'nextPageToken': obj["next_page_token"],
        });
        delete jsonObj["root_uri"];
        delete jsonObj["next_page_token"];
        return jsonObj;
    }
    ArtifactList.getDeserializedJsonObj = getDeserializedJsonObj;
})(ArtifactList || (exports.ArtifactList = ArtifactList = {}));
