...
**/
export declare enum AsyncOperationActionType {
    Unknown = "UNKNOWN",
...
export declare namespace AsyncOperationActionType {
    function getJsonObj(obj: AsyncOperationActionType): AsyncOperationActionType;
    function getDeserializedJsonObj(obj: AsyncOperationActionType): AsyncOperationActionType;
}
