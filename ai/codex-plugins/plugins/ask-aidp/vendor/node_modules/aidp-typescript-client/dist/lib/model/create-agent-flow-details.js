...
exports.CreateAgentFlowDetails = void 0;
const model = __importStar(require("../model"));
var CreateAgentFlowDetails;
(function (CreateAgentFlowDetails) {
    let Type;
    (function (Type) {
        Type["Canvas"] = "CANVAS";
        Type["Code"] = "CODE";
    })(Type = CreateAgentFlowDetails.Type || (CreateAgentFlowDetails.Type = {}));
    ...
    CreateAgentFlowDetails.getJsonObj = getJsonObj;
    ;
    ...
    CreateAgentFlowDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(CreateAgentFlowDetails || (exports.CreateAgentFlowDetails = CreateAgentFlowDetails = {}));
//# sourceMappingURL=create-agent-flow-details.js.map