...
export declare namespace CredentialV2Summary {
    function getJsonObj(obj: CredentialV2Summary): object;
    function getDeserializedJsonObj(obj: CredentialV2Summary): object;
}
