...
export declare namespace KnowledgeBaseJobRunSummary {
    function getJsonObj(obj: KnowledgeBaseJobRunSummary): object;
    function getDeserializedJsonObj(obj: KnowledgeBaseJobRunSummary): object;
}
