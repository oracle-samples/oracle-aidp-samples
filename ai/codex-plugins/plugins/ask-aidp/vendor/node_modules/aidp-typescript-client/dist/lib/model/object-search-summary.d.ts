...
export declare namespace ObjectSearchSummary {
    function getJsonObj(obj: ObjectSearchSummary): object;
    function getDeserializedJsonObj(obj: ObjectSearchSummary): object;
}
