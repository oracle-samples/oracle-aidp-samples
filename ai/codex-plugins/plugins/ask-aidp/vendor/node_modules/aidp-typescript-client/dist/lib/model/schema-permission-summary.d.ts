...
export declare namespace SchemaPermissionSummary {
    enum GranteePermissions {
        Select = "SELECT",
        Manage = "MANAGE",
        Write = "WRITE",
    ...
    function getJsonObj(obj: SchemaPermissionSummary): object;
    function getDeserializedJsonObj(obj: SchemaPermissionSummary): object;
}
