...
export declare namespace ToolPermissionSummary {
    enum GranteePermissions {
        Read = "READ",
        Manage = "MANAGE",
        Admin = "ADMIN"
    }
    function getJsonObj(obj: ToolPermissionSummary): object;
    function getDeserializedJsonObj(obj: ToolPermissionSummary): object;
}
