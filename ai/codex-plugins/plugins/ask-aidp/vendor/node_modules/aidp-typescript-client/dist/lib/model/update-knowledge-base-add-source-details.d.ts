...
export declare namespace UpdateKnowledgeBaseAddSourceDetails {
    function getJsonObj(obj: UpdateKnowledgeBaseAddSourceDetails): object;
    function getDeserializedJsonObj(obj: UpdateKnowledgeBaseAddSourceDetails): object;
}
