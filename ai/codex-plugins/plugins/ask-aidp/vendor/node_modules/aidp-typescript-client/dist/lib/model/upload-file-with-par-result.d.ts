...
export declare namespace UploadFileWithParResult {
    function getJsonObj(obj: UploadFileWithParResult): object;
    function getDeserializedJsonObj(obj: UploadFileWithParResult): object;
}
