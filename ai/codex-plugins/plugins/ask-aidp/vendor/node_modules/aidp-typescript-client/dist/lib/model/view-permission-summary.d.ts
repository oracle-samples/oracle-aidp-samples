...
export declare namespace ViewPermissionSummary {
    ...
    function getJsonObj(obj: ViewPermissionSummary): object;
    function getDeserializedJsonObj(obj: ViewPermissionSummary): object;
}
