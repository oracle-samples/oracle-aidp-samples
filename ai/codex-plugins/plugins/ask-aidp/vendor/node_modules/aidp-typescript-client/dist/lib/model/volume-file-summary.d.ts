...
export declare namespace VolumeFileSummary {
    enum Type {
        File = "FILE",
        Folder = "FOLDER",
        /**
    ...
    function getJsonObj(obj: VolumeFileSummary): object;
    function getDeserializedJsonObj(obj: VolumeFileSummary): object;
}
