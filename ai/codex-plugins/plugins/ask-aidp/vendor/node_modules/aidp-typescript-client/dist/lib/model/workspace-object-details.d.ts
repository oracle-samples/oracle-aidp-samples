...
export declare namespace WorkspaceObjectDetails {
    enum Type {
        Notebook = "NOTEBOOK",
        Job = "JOB",
        LakeFlow = "LAKE_FLOW",
    ...
    function getJsonObj(obj: WorkspaceObjectDetails): object;
    function getDeserializedJsonObj(obj: WorkspaceObjectDetails): object;
}
