...
export declare namespace WorkspaceObjectSearchSummary {
    function getJsonObj(obj: WorkspaceObjectSearchSummary): object;
    function getDeserializedJsonObj(obj: WorkspaceObjectSearchSummary): object;
}
