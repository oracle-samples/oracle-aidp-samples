...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/CommitPushGitRepository.ts.html |here} to see how to use CommitPushGitRepositoryRequest.
 */
export interface CommitPushGitRepositoryRequest extends common.BaseRequest {
/**
