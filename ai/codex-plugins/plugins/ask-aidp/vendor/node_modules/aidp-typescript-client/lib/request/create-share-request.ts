...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/CreateShare.ts.html |here} to see how to use CreateShareRequest.
 */
export interface CreateShareRequest extends common.BaseRequest {
/**
