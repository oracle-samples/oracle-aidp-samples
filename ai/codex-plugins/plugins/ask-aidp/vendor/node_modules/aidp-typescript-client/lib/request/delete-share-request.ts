...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/DeleteShare.ts.html |here} to see how to use DeleteShareRequest.
 */
export interface DeleteShareRequest extends common.BaseRequest {
/**
