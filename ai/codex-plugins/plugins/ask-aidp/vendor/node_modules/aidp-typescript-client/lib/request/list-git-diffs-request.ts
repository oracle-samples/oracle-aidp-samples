...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListGitDiffs.ts.html |here} to see how to use ListGitDiffsRequest.
 */
export interface ListGitDiffsRequest extends common.BaseRequest {
/**
...
export namespace ListGitDiffsRequest {
