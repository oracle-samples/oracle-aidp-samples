...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListRecentJobRuns.ts.html |here} to see how to use ListRecentJobRunsRequest.
 */
export interface ListRecentJobRunsRequest extends common.BaseRequest {
/**
...
export namespace ListRecentJobRunsRequest {
