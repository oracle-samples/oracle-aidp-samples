...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListShares.ts.html |here} to see how to use ListSharesRequest.
 */
export interface ListSharesRequest extends common.BaseRequest {
/**
