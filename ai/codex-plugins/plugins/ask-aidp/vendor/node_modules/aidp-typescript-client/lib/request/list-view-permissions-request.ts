...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListViewPermissions.ts.html |here} to see how to use ListViewPermissionsRequest.
 */
export interface ListViewPermissionsRequest extends common.BaseRequest {
/**
...
export namespace ListViewPermissionsRequest {
