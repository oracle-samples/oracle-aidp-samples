...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListWorkspaceObjectPermissions.ts.html |here} to see how to use ListWorkspaceObjectPermissionsRequest.
 */
export interface ListWorkspaceObjectPermissionsRequest extends common.BaseRequest {
/**
...
export namespace ListWorkspaceObjectPermissionsRequest {
