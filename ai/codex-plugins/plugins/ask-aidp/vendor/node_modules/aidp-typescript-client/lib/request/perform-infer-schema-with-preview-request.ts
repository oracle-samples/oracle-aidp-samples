...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/PerformInferSchemaWithPreview.ts.html |here} to see how to use PerformInferSchemaWithPreviewRequest.
 */
export interface PerformInferSchemaWithPreviewRequest extends common.BaseRequest {
/**
