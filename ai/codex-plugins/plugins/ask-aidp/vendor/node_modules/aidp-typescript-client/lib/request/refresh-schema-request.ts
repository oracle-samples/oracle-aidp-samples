...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/RefreshSchema.ts.html |here} to see how to use RefreshSchemaRequest.
 */
export interface RefreshSchemaRequest extends common.BaseRequest {
/**
