...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/RefreshTable.ts.html |here} to see how to use RefreshTableRequest.
 */
export interface RefreshTableRequest extends common.BaseRequest {
/**
