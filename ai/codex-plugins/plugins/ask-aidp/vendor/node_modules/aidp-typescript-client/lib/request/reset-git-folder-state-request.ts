...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ResetGitFolderState.ts.html |here} to see how to use ResetGitFolderStateRequest.
 */
export interface ResetGitFolderStateRequest extends common.BaseRequest {
/**
