...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/RetrievePar.ts.html |here} to see how to use RetrieveParRequest.
 */
export interface RetrieveParRequest extends common.BaseRequest {
/**
