...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/UpdateDir.ts.html |here} to see how to use UpdateDirRequest.
 */
export interface UpdateDirRequest extends common.BaseRequest {
/**
