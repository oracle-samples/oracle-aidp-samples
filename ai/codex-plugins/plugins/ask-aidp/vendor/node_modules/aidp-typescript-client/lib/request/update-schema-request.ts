...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/UpdateSchema.ts.html |here} to see how to use UpdateSchemaRequest.
 */
export interface UpdateSchemaRequest extends common.BaseRequest {
/**
