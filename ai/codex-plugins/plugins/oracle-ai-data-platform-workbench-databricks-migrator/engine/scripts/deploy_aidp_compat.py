...
Usage:
    python3 $HOME/.aidp-migrator/engine/scripts/deploy_aidp_compat.py --cluster <your-cluster-id>
"""
...
DATALAKE_OCID = os.environ.get("AIDP_DATALAKE", "")
WORKSPACE_ID = os.environ.get("AIDP_WORKSPACE", "")
