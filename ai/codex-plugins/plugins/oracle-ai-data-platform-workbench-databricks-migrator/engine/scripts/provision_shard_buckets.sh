...
# budget so 2,500 parallel jobs do not collectively trip the OCI Java SDK
...
#   export AIDP_SHARD_PREFIX=migration-shard
...
Required:
  --prefix <name>          Bucket name prefix, e.g. 'migration-shard'
