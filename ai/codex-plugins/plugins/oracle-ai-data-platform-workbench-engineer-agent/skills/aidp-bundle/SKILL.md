...
(Oracle-supported, versioned — see [references/aidp-cli-map.md]($HOME/.aidp/references/aidp-cli-map.md)):
...
[references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md)) when the CLI isn't installed.
...
> [references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md)), not that the request was
...
and confirm first — see [references/payloads.md]($HOME/.aidp/references/payloads.md).
...
- [references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md) · [references/rest-endpoint-map.md]($HOME/.aidp/references/rest-endpoint-map.md)
