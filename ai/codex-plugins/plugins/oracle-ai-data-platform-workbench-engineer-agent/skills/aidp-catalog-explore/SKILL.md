...
[references/aidp-cli-map.md]($HOME/.aidp/references/aidp-cli-map.md) for the full command map and
[references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md) for base URL + auth ladder.
...
- [references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md) · [references/no-mcp-rest-map.md]($HOME/.aidp/references/no-mcp-rest-map.md)
