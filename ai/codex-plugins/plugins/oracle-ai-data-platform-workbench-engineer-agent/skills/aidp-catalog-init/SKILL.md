...
[references/aidp-cli-map.md]($HOME/.aidp/references/aidp-cli-map.md) for the full skill→command map and
[references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md) for base URL + auth ladder + conventions.
...
`--profile DEFAULT` — see [references/no-mcp-rest-map.md]($HOME/.aidp/references/no-mcp-rest-map.md)):
```bash
...
- `--with-counts` — also fetch row counts / distinct values via the bundled SQL helper (uses the cluster,
  ...
  ```bash
  python "$HOME/.aidp/aidp_sql.py" --region <r> --datalake <DATALAKE_OCID> --workspace <ws> --cluster <key> \
  ...
  [references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md) for the control-plane side.
...
- [references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md) · [references/no-mcp-rest-map.md]($HOME/.aidp/references/no-mcp-rest-map.md) · [references/semantic-model.md]($HOME/.aidp/references/semantic-model.md)
