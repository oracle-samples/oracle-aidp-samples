...
[references/aidp-cli-map.md]($HOME/.aidp/references/aidp-cli-map.md) for the full command map,
[references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md) for base URL + auth ladder + async/error
conventions, and [references/no-mcp-rest-map.md]($HOME/.aidp/references/no-mcp-rest-map.md) for REST endpoint shapes.
...
`.aidp/payloads/` and confirm first ([references/payloads.md]($HOME/.aidp/references/payloads.md)).
...
- [references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md) — base URL, auth ladder, async/errors
- [references/no-mcp-rest-map.md]($HOME/.aidp/references/no-mcp-rest-map.md) — cluster endpoint map + start-400 note
- [references/rest-endpoint-map.md]($HOME/.aidp/references/rest-endpoint-map.md) — verification ledger
