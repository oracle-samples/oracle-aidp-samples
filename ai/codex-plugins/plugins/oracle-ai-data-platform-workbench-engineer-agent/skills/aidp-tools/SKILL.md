...
> write path is **VERIFIED live 2026-06-10** (round-trip on `<TENANCY>`): `POST …/workspaces/<ws>/tools` → **200**
...
`CUSTOM_TOOL`/`MCP_TOOL`) — see [references/agent-flow-nodes.md]($HOME/.aidp/references/agent-flow-nodes.md). RAG
...
- Mutation gate: create/update/delete change state — show the body, confirm first, persist to `.aidp/payloads/`
  ([references/payloads.md]($HOME/.aidp/references/payloads.md)). Don't inline secrets — use `aidp-credentials`.
...
## References
- [aidp-agent-flows](../aidp-agent-flows/SKILL.md) · [references/agent-flow-nodes.md]($HOME/.aidp/references/agent-flow-nodes.md) · [aidp-knowledge-bases](../aidp-knowledge-bases/SKILL.md) (RAG) · [aidp-agent-highcode](../aidp-agent-highcode/SKILL.md) (code-first tools)
- [references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md) · [references/rest-endpoint-map.md]($HOME/.aidp/references/rest-endpoint-map.md) · [references/payloads.md]($HOME/.aidp/references/payloads.md)
