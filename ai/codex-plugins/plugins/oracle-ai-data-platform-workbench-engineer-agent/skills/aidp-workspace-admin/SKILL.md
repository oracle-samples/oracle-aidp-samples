...
[references/aidp-cli-map.md]($HOME/.aidp/references/aidp-cli-map.md) for the command map and
[references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md) for the base URL, auth ladder,
...
body to `.aidp/payloads/` and confirm first ([references/payloads.md]($HOME/.aidp/references/payloads.md)).
...
- [references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md) — base URL, auth ladder, conventions
- [references/rest-endpoint-map.md]($HOME/.aidp/references/rest-endpoint-map.md) — live-verified endpoint status
- [references/no-mcp-rest-map.md]($HOME/.aidp/references/no-mcp-rest-map.md) — full no-MCP REST coverage
