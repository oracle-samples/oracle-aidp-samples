...
## CLI (preferred)
Per [references/aidp-cli-map.md]($HOME/.aidp/references/aidp-cli-map.md): `workspace-object create | get | head |
...
`.aidp/payloads/` and confirm with the user before running (see [references/payloads.md]($HOME/.aidp/references/payloads.md)).

**Fallback (no CLI)** — same REST + auth via the workspace-scoped Jupyter **Notebook contents API** with
`oci raw-request` (auth ladder in [references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md)):
...
> through the WebSocket Jupyter helper (`$HOME/.aidp/aidp_sql.py`, used by `aidp-notebooks` — auto-creates notebooks,
...
## References
- [references/aidp-cli-map.md]($HOME/.aidp/references/aidp-cli-map.md) · [references/payloads.md]($HOME/.aidp/references/payloads.md) · [references/oci-raw-request.md]($HOME/.aidp/references/oci-raw-request.md) · [references/no-mcp-rest-map.md]($HOME/.aidp/references/no-mcp-rest-map.md) · pairs with `aidp-notebooks`, `aidp-volumes`
