...
def bootstrap_helpers() -> List[dict]:
    ...
    Codex, when driving via MCP) can confirm the setup worked.
    """
    return [
        md(
            ...
            "\n",
            "If you haven't uploaded the helpers yet, ask Codex: *\"set up the AIDP connectors plugin in this workspace\"* — the `aidp-connectors-bootstrap` skill drives the upload via MCP. Or upload `scripts/oracle_ai_data_platform_connectors/` manually via the AIDP UI to that path.\n",
            "\n",
        ...
        code(
            ...
            "    raise RuntimeError(\n",
            "        f'Helpers not found at {expected}. Run the aidp-connectors-bootstrap skill (ask Codex: \"set up the AIDP connectors plugin\") '\n",
